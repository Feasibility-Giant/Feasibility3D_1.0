...
#include <memory>
#include "../../../src/Gui/GraphvizView.h"
...
struct qt_meta_stringdata_Gui__GraphvizView_t {
    QByteArrayData data[6];
    char stringdata0[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Gui__GraphvizView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Gui__GraphvizView_t qt_meta_stringdata_Gui__GraphvizView = {
    {
QT_MOC_LITERAL(0, 0, 17), // "Gui::GraphvizView"
QT_MOC_LITERAL(1, 18, 11), // "svgFileRead"
...
QT_MOC_LITERAL(5, 42, 4) // "done"
    ...
    "Gui::GraphvizView\0svgFileRead\0\0data\0"
    "error\0done"
};
...
QT_INIT_METAOBJECT const QMetaObject Gui::GraphvizView::staticMetaObject = { {
    QMetaObject::SuperData::link<MDIView::staticMetaObject>(),
    qt_meta_stringdata_Gui__GraphvizView.data,
    qt_meta_data_Gui__GraphvizView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Gui::GraphvizView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gui__GraphvizView.stringdata0))
