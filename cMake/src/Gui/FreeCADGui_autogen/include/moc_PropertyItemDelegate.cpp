...
#include <memory>
#include "../../../../../src/Gui/propertyeditor/PropertyItemDelegate.h"
...
struct qt_meta_stringdata_Gui__PropertyEditor__PropertyItemDelegate_t {
    QByteArrayData data[1];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Gui__PropertyEditor__PropertyItemDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Gui__PropertyEditor__PropertyItemDelegate_t qt_meta_stringdata_Gui__PropertyEditor__PropertyItemDelegate = {
    {
...
QT_INIT_METAOBJECT const QMetaObject Gui::PropertyEditor::PropertyItemDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_Gui__PropertyEditor__PropertyItemDelegate.data,
    qt_meta_data_Gui__PropertyEditor__PropertyItemDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Gui::PropertyEditor::PropertyItemDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gui__PropertyEditor__PropertyItemDelegate.stringdata0))
