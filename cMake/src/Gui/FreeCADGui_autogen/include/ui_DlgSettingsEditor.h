...
public:
    ...
    void setupUi(QWidget *Gui__Dialog__DlgSettingsEditor)
    {
        if (Gui__Dialog__DlgSettingsEditor->objectName().isEmpty())
            Gui__Dialog__DlgSettingsEditor->setObjectName(QString::fromUtf8("Gui__Dialog__DlgSettingsEditor"));
        ...
        EnableBlockCursor->setObjectName(QString::fromUtf8("EnableBlockCursor"));
