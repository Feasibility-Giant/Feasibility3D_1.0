...
public:
    ...
    void setupUi(QDialog *Gui__DlgObjectSelection)
    {
        ...
        inList->setObjectName(QString::fromUtf8("inList"));
        ...
        checkBoxAutoDeps->setObjectName(QString::fromUtf8("checkBoxAutoDeps"));

        horizontalLayout->addWidget(checkBoxAutoDeps);

        checkBoxShowDeps = new QCheckBox(Gui__DlgObjectSelection);
        checkBoxShowDeps->setObjectName(QString::fromUtf8("checkBoxShowDeps"));
