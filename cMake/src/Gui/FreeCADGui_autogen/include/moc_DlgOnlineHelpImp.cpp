...
#include <memory>
#include "../../../../../src/Gui/DlgOnlineHelpImp.h"
...
struct qt_meta_stringdata_Gui__Dialog__DlgOnlineHelpImp_t {
    QByteArrayData data[1];
    char stringdata0[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Gui__Dialog__DlgOnlineHelpImp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Gui__Dialog__DlgOnlineHelpImp_t qt_meta_stringdata_Gui__Dialog__DlgOnlineHelpImp = {
    {
QT_MOC_LITERAL(0, 0, 29) // "Gui::Dialog::DlgOnlineHelpImp"
...
QT_INIT_METAOBJECT const QMetaObject Gui::Dialog::DlgOnlineHelpImp::staticMetaObject = { {
    QMetaObject::SuperData::link<PreferencePage::staticMetaObject>(),
    qt_meta_stringdata_Gui__Dialog__DlgOnlineHelpImp.data,
    qt_meta_data_Gui__Dialog__DlgOnlineHelpImp,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Gui::Dialog::DlgOnlineHelpImp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gui__Dialog__DlgOnlineHelpImp.stringdata0))
