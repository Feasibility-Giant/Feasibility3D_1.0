...
public:
    ...
    void setupUi(QWidget *Gui__Dialog__DlgSettingsCacheDirectory)
    {
        if (Gui__Dialog__DlgSettingsCacheDirectory->objectName().isEmpty())
            Gui__Dialog__DlgSettingsCacheDirectory->setObjectName(QString::fromUtf8("Gui__Dialog__DlgSettingsCacheDirectory"));
        ...
        cacheLocation->setObjectName(QString::fromUtf8("cacheLocation"));
        ...
        comboBoxLimit->setObjectName(QString::fromUtf8("comboBoxLimit"));
        ...
        labelCurrentCache->setObjectName(QString::fromUtf8("labelCurrentCache"));
