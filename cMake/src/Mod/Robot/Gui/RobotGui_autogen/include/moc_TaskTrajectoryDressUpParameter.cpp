...
#include <memory>
#include "../../../../../../../src/Mod/Robot/Gui/TaskTrajectoryDressUpParameter.h"
...
struct qt_meta_stringdata_RobotGui__TaskTrajectoryDressUpParameter_t {
    QByteArrayData data[3];
    char stringdata0[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RobotGui__TaskTrajectoryDressUpParameter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RobotGui__TaskTrajectoryDressUpParameter_t qt_meta_stringdata_RobotGui__TaskTrajectoryDressUpParameter = {
    {
QT_MOC_LITERAL(0, 0, 40), // "RobotGui::TaskTrajectoryDress..."
QT_MOC_LITERAL(1, 41, 18), // "createPlacementDlg"
...
QT_INIT_METAOBJECT const QMetaObject RobotGui::TaskTrajectoryDressUpParameter::staticMetaObject = { {
    QMetaObject::SuperData::link<Gui::TaskView::TaskBox::staticMetaObject>(),
    qt_meta_stringdata_RobotGui__TaskTrajectoryDressUpParameter.data,
    qt_meta_data_RobotGui__TaskTrajectoryDressUpParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RobotGui::TaskTrajectoryDressUpParameter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RobotGui__TaskTrajectoryDressUpParameter.stringdata0))
