...
#include <memory>
#include "../../../../../../../src/Mod/Robot/Gui/TaskRobotMessages.h"
...
struct qt_meta_stringdata_RobotGui__TaskRobotMessages_t {
    QByteArrayData data[1];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RobotGui__TaskRobotMessages_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RobotGui__TaskRobotMessages_t qt_meta_stringdata_RobotGui__TaskRobotMessages = {
    {
QT_MOC_LITERAL(0, 0, 27) // "RobotGui::TaskRobotMessages"
...
QT_INIT_METAOBJECT const QMetaObject RobotGui::TaskRobotMessages::staticMetaObject = { {
    QMetaObject::SuperData::link<Gui::TaskView::TaskBox::staticMetaObject>(),
    qt_meta_stringdata_RobotGui__TaskRobotMessages.data,
    qt_meta_data_RobotGui__TaskRobotMessages,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RobotGui::TaskRobotMessages::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RobotGui__TaskRobotMessages.stringdata0))
