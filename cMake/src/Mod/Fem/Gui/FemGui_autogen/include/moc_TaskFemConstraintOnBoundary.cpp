...
#include <memory>
#include "../../../../../../../src/Mod/Fem/Gui/TaskFemConstraintOnBoundary.h"
...
struct qt_meta_stringdata_FemGui__TaskFemConstraintOnBoundary_t {
    QByteArrayData data[8];
    char stringdata0[120];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FemGui__TaskFemConstraintOnBoundary_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FemGui__TaskFemConstraintOnBoundary_t qt_meta_stringdata_FemGui__TaskFemConstraintOnBoundary = {
    {
QT_MOC_LITERAL(0, 0, 35), // "FemGui::TaskFemConstraintOnBo..."
QT_MOC_LITERAL(1, 36, 15), // "onButtonToggled"
QT_MOC_LITERAL(2, 52, 0), // ""
QT_MOC_LITERAL(3, 53, 16), // "QAbstractButton*"
QT_MOC_LITERAL(4, 70, 6), // "button"
QT_MOC_LITERAL(5, 77, 7), // "checked"
QT_MOC_LITERAL(6, 85, 14), // "addToSelection"
QT_MOC_LITERAL(7, 100, 19) // "removeFromSelection"

    },
    "FemGui::TaskFemConstraintOnBoundary\0"
    "onButtonToggled\0\0QAbstractButton*\0"
    "button\0checked\0addToSelection\0"
    "removeFromSelection"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_FemGui__TaskFemConstraintOnBoundary[] = {
...
QT_INIT_METAOBJECT const QMetaObject FemGui::TaskFemConstraintOnBoundary::staticMetaObject = { {
    QMetaObject::SuperData::link<TaskFemConstraint::staticMetaObject>(),
    qt_meta_stringdata_FemGui__TaskFemConstraintOnBoundary.data,
    qt_meta_data_FemGui__TaskFemConstraintOnBoundary,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *FemGui::TaskFemConstraintOnBoundary::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FemGui__TaskFemConstraintOnBoundary.stringdata0))
