...
public:
    ...
    void setupUi(QDialog *MeshGui__DlgRegularSolid)
    {
        ...
        spacerItem1 = new QSpacerItem(31, 81, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spacerItem2 = new QSpacerItem(31, 91, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spacerItem3 = new QSpacerItem(21, 151, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spacerItem4 = new QSpacerItem(31, 81, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spacerItem5 = new QSpacerItem(20, 91, QSizePolicy::Minimum, QSizePolicy::Expanding);
