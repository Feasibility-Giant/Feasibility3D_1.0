...
public:
    ...
    void setupUi(QWidget *MeshPartGui__Tessellation)
    {
        ...
        groupBoxMeshingOptions->setObjectName(QString::fromUtf8("groupBoxMeshingOptions"));
        ...
        labelAngularDeviation->setObjectName(QString::fromUtf8("labelAngularDeviation"));

        gridLayout->addWidget(labelAngularDeviation, 1, 0, 1, 1);

        spinAngularDeviation = new Gui::QuantitySpinBox(pageStandard);
        spinAngularDeviation->setObjectName(QString::fromUtf8("spinAngularDeviation"));
        ...
        relativeDeviation->setObjectName(QString::fromUtf8("relativeDeviation"));

        gridLayout_3->addWidget(relativeDeviation, 1, 0, 1, 1);

        meshShapeColors = new QCheckBox(pageStandard);
        meshShapeColors->setObjectName(QString::fromUtf8("meshShapeColors"));

        gridLayout_3->addWidget(meshShapeColors, 2, 0, 1, 1);

        groupsFaceColors = new QCheckBox(pageStandard);
        groupsFaceColors->setObjectName(QString::fromUtf8("groupsFaceColors"));
        ...
        pageMefisto->setObjectName(QString::fromUtf8("pageMefisto"));
        gridLayout_9 = new QGridLayout(pageMefisto);
        gridLayout_9->setObjectName(QString::fromUtf8("gridLayout_9"));
        horizontalLayout_2 = new QHBoxLayout();
        horizontalLayout_2->setObjectName(QString::fromUtf8("horizontalLayout_2"));
        checkMaximumEdgeLength = new QCheckBox(pageMefisto);
        checkMaximumEdgeLength->setObjectName(QString::fromUtf8("checkMaximumEdgeLength"));
        ...
        spinMaximumEdgeLength->setObjectName(QString::fromUtf8("spinMaximumEdgeLength"));
        ...
        estimateMaximumEdgeLength->setObjectName(QString::fromUtf8("estimateMaximumEdgeLength"));
        ...
        pageNetgen->setObjectName(QString::fromUtf8("pageNetgen"));
        gridLayout_5 = new QGridLayout(pageNetgen);
        gridLayout_5->setObjectName(QString::fromUtf8("gridLayout_5"));
        gridLayout_4 = new QGridLayout();
        gridLayout_4->setObjectName(QString::fromUtf8("gridLayout_4"));
        labelFineness = new QLabel(pageNetgen);
        labelFineness->setObjectName(QString::fromUtf8("labelFineness"));
        ...
        comboFineness->addItem(QString());
        comboFineness->addItem(QString());
        comboFineness->setObjectName(QString::fromUtf8("comboFineness"));
        ...
        labelGrading->setObjectName(QString::fromUtf8("labelGrading"));

        gridLayout_2->addWidget(labelGrading, 0, 0, 1, 1);

        doubleGrading = new QDoubleSpinBox(pageNetgen);
        doubleGrading->setObjectName(QString::fromUtf8("doubleGrading"));
        ...
        labelEdgeElements->setObjectName(QString::fromUtf8("labelEdgeElements"));

        gridLayout_2->addWidget(labelEdgeElements, 1, 0, 1, 1);

        spinEdgeElements = new QDoubleSpinBox(pageNetgen);
        spinEdgeElements->setObjectName(QString::fromUtf8("spinEdgeElements"));
        ...
        labelCurvatureElements->setObjectName(QString::fromUtf8("labelCurvatureElements"));

        gridLayout_2->addWidget(labelCurvatureElements, 2, 0, 1, 1);

        spinCurvatureElements = new QDoubleSpinBox(pageNetgen);
        spinCurvatureElements->setObjectName(QString::fromUtf8("spinCurvatureElements"));
        ...
        checkOptimizeSurface->setObjectName(QString::fromUtf8("checkOptimizeSurface"));
        ...
        checkSecondOrder->setObjectName(QString::fromUtf8("checkSecondOrder"));

        gridLayout_4->addWidget(checkSecondOrder, 3, 0, 1, 2);

        checkQuadDominated = new QCheckBox(pageNetgen);
        checkQuadDominated->setObjectName(QString::fromUtf8("checkQuadDominated"));
        ...
        checkBoxDontQuit->setObjectName(QString::fromUtf8("checkBoxDontQuit"));
