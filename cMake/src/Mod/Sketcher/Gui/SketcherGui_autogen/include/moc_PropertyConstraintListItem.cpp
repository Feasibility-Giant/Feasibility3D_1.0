...
#include <memory>
#include "../../../../../../../src/Mod/Sketcher/Gui/PropertyConstraintListItem.h"
...
struct qt_meta_stringdata_SketcherGui__PropertyConstraintListItem_t {
    QByteArrayData data[1];
    char stringdata0[40];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SketcherGui__PropertyConstraintListItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SketcherGui__PropertyConstraintListItem_t qt_meta_stringdata_SketcherGui__PropertyConstraintListItem = {
    {
QT_MOC_LITERAL(0, 0, 39) // "SketcherGui::PropertyConstrai..."
...
QT_INIT_METAOBJECT const QMetaObject SketcherGui::PropertyConstraintListItem::staticMetaObject = { {
    QMetaObject::SuperData::link<Gui::PropertyEditor::PropertyItem::staticMetaObject>(),
    qt_meta_stringdata_SketcherGui__PropertyConstraintListItem.data,
    qt_meta_data_SketcherGui__PropertyConstraintListItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SketcherGui::PropertyConstraintListItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SketcherGui__PropertyConstraintListItem.stringdata0))
