...
#include <memory>
#include "../../../../../../../src/Mod/Sketcher/Gui/TaskSketcherCreateCommands.h"
...
struct qt_meta_stringdata_Gui__TaskView__TaskSketcherCreateCommands_t {
    QByteArrayData data[1];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Gui__TaskView__TaskSketcherCreateCommands_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Gui__TaskView__TaskSketcherCreateCommands_t qt_meta_stringdata_Gui__TaskView__TaskSketcherCreateCommands = {
    {
QT_MOC_LITERAL(0, 0, 41) // "Gui::TaskView::TaskSketcherCr..."
...
QT_INIT_METAOBJECT const QMetaObject Gui::TaskView::TaskSketcherCreateCommands::staticMetaObject = { {
    QMetaObject::SuperData::link<TaskBox::staticMetaObject>(),
    qt_meta_stringdata_Gui__TaskView__TaskSketcherCreateCommands.data,
    qt_meta_data_Gui__TaskView__TaskSketcherCreateCommands,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Gui::TaskView::TaskSketcherCreateCommands::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gui__TaskView__TaskSketcherCreateCommands.stringdata0))
