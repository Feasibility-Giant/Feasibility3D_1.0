...
#include <memory>
#include "../../../../../../../src/Mod/Part/Gui/DlgPartBoxImp.h"
...
struct qt_meta_stringdata_PartGui__DlgPartBoxImp_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartGui__DlgPartBoxImp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartGui__DlgPartBoxImp_t qt_meta_stringdata_PartGui__DlgPartBoxImp = {
    {
QT_MOC_LITERAL(0, 0, 22) // "PartGui::DlgPartBoxImp"
...
QT_INIT_METAOBJECT const QMetaObject PartGui::DlgPartBoxImp::staticMetaObject = { {
    QMetaObject::SuperData::link<Gui::LocationDialogUiImp::staticMetaObject>(),
    qt_meta_stringdata_PartGui__DlgPartBoxImp.data,
    qt_meta_data_PartGui__DlgPartBoxImp,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartGui::DlgPartBoxImp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartGui__DlgPartBoxImp.stringdata0))
