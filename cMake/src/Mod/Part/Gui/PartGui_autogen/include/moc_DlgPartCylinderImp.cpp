...
#include <memory>
#include "../../../../../../../src/Mod/Part/Gui/DlgPartCylinderImp.h"
...
struct qt_meta_stringdata_PartGui__DlgPartCylinderImp_t {
    QByteArrayData data[1];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartGui__DlgPartCylinderImp_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartGui__DlgPartCylinderImp_t qt_meta_stringdata_PartGui__DlgPartCylinderImp = {
    {
QT_MOC_LITERAL(0, 0, 27) // "PartGui::DlgPartCylinderImp"
...
QT_INIT_METAOBJECT const QMetaObject PartGui::DlgPartCylinderImp::staticMetaObject = { {
    QMetaObject::SuperData::link<Gui::LocationDialogUiImp::staticMetaObject>(),
    qt_meta_stringdata_PartGui__DlgPartCylinderImp.data,
    qt_meta_data_PartGui__DlgPartCylinderImp,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartGui::DlgPartCylinderImp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartGui__DlgPartCylinderImp.stringdata0))
